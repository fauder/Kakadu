...
/* Textures: */
	...
	transparent_window_texture = texture_database.CreateAssetFromFile( "Transparent Window",
																	   AssetDir R"(blending_transparent_window.png)" );
...
void BloomDemoApplication::OnFramebufferResizeEvent( const i32 width_new_pixels, const i32 height_new_pixels )
{
}
...
void BloomDemoApplication::ResetMaterialData()
{
	...
	for( i32 i = 0; i < LIGHT_POINT_COUNT; i++ )
